...
BasicGame.Instructions.prototype = {
  ...
  create: function () {
    ...
    this.instructionsTitleText = this.game.add.bitmapText(100,100, 'atari', 'BREAKSOUT INSTRUCTIONS', 48);
  ...
  update: function () {
    ...
    if (!this.game.device.desktop && this.game.input.activePointer.justPressed(30)) {
